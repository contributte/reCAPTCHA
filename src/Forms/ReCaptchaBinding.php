...
final class ReCaptchaBinding
{
	...
	public static function bind(ReCaptchaProvider $provider, string $name = 'addReCaptcha'): void
	{
		...
		Container::extensionMethod($name, function (Container $container, string $name = 'recaptcha', string $label = 'ReCaptcha', bool|string $required = true, ?string $message = null) use ($provider): ReCaptchaField {
